  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-4 py-8 sm:px-6">
      <div className="mb-8">
        ...
        <h1 className="mt-2 text-3xl font-semibold text-salon-ink">Day close</h1>
      ...
      <form
        onSubmit={handleAdd}
        className="mb-6 grid gap-3 rounded-2xl border border-salon-beige/30 bg-salon-surface p-5 sm:grid-cols-[1fr_1fr_auto]"
      >
        ...
        <button
          type="submit"
          disabled={saving}
          className="inline-flex h-11 items-center justify-center gap-2 self-end salon-gold-btn rounded-xl px-4 text-sm font-bold text-black disabled:opacity-60"
        >
        ...
        {loading ? (
          ...
          <ul className="divide-y divide-salon-beige/30">
            {days.map((day) => (
              ...
              >
                <div>
                  <p className="font-medium text-salon-ink">{day.dateKey}</p>
